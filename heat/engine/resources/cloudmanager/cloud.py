...
class Cloud(object):
    ...
    def config_openstack_vpn(self, openstack_api_gw, openstack_api_subnet,
        ...
        api_vpn = VPN(self.api_vpn["public_ip"], VpnConstant.AWS_VPN_ROOT,
                      VpnConstant.AWS_VPN_ROOT_PWD)
        tunnel_vpn = VPN(self.tunnel_vpn["public_ip"], VpnConstant.AWS_VPN_ROOT,
                         VpnConstant.AWS_VPN_ROOT_PWD)
        ...
        api_vpn.add_tunnel(conn_name["api_conn_name"],
                           self.api_vpn["public_ip"],
                           self.api_vpn["private_subnet"],
        ...
        tunnel_vpn.add_tunnel(conn_name["tunnel_conn_name"],
                              self.tunnel_vpn["public_ip"],
                              self.tunnel_vpn["private_subnet"],
                              openstack_tunnel_gw, openstack_tunnel_subnet)
